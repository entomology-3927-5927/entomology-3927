...
| :---- | :---- | :---- | :---- |
| **1\. Foundations: Thinking Like a Data Scientist** | Week 1: *2026-09-18* | What is Data Science in Ecology? | Data science vs. statistics; reproducibility crisis; workflow (data → insight → communication) |
|  | Week 2: *2026-09-25*  | Project Organization & Reproducibility | Folder structure; naming conventions; scripts vs. GUI; intro to R Markdown / Quarto |
| **2\. Version Control** | Week 3: *2026-10-02* | Git Fundamentals | Version control concepts; commit, diff, history |
|  | Week 4: *2026-10-09* | GitHub Collaboration | Repositories; branching; pull requests; sharing code; course with GitHub |
| **3\. R for Data Handling & Exploration** | Week 5: *2026-10-16* | Data Wrangling I | Tidy data principles; the basic verbs of tidyverse |
|  | Week 6: *2026-10-23* | Data Wrangling II | Joins; reshaping; missing data; pipelines |
|  | Week 7: *2026-10-30* | Data Visualization | Visualization principles; exploratory plots; visualizing uncertainty |
|  | Week 8: *2026-11-06* | Data Visualization II | EDA and Advanced visuals (maps, complex figures) |
| **3\. Automation, Functions, & Scaling Up** | Week 9: *2026-11-13* | Functions & Automation | Writing functions; reusable code; iteration (loops/map) |
|  | Week 10: *2026-11-20* | Multi-file Workflows | Batch processing; project organization; scalable workflows |
| **5\. Data Management & Databases** | Week 11: *2026-12-04* | Data Management & Metadata | Data management plans; metadata standards; documentation |
|  | Week 12: *2026-12-11* | Databases & Data Quality | Relational data; structuring datasets; validation & QC |
